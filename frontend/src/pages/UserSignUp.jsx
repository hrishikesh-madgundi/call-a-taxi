  ...
  return (
    ...
    <h1 className='w-50 text-3xl mb-10 text-black font-bold p-2 rounded'>Call-a-Taxi</h1>
      ...
      <p className='text-center'>Already Have an Account ? <Link to='/login' className='text-blue-600'>Login here</Link></p>
        ...
        <div>
            <p className='text-sm'>By proceeding you consent to get calls, WhatsApp or SMS messages, including by automated means, from Uber and it's affilates to the number provided.</p>
        </div>
    </div>
  )
}
